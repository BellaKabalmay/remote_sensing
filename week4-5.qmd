...
The NDVI results show a clear distribution of vegetation across London. Areas with high NDVI values (green) indicate the presence of vegetation such as parks and green spaces, while the city center shows low NDVI values related to the density of buildings and built-up surfaces. The Thames River is clearly visible as an area with a very low NDVI value due to the characteristics of the water.

Texture analysis provides additional information regarding spatial structure. Urban areas exhibit more complex (heterogeneous) textures, while vegetated areas tend to be more homogeneous. The combination of NDVI and texture provides a more comprehensive understanding because NDVI is spectral-based, while texture captures spatial variation. Furthermore, the use of median composites has proven important because it can reduce the effects of clouds and temporal variations between images. Therefore, in my opinion, preprocessing is a crucial step in remote sensing data analysis.
