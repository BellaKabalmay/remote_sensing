...
![Fractions water, urban, vegetations](img/Fractions.png){width="70%"} 

![Hard Classification](img/Hard_classification.png){width="70%"}
...
![Segmented Image](img/Segmented_image.png){width="70%"}

![Obia Classification](img/Obia_classification.png){width="70%"}
