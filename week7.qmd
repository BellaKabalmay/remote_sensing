...
![Fractions water, urban, vegetations](img/Fractions.png){width="170"}
![Hard Classification](img/Hard_classification.png){width="170"}
...
![Segmented Image](img/Segmented_image.png){width="170"}

![Obia Classification](img/Obia_classification.png){width="170"}
